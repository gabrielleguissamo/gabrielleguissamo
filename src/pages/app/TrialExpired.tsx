  ...
  return (
    <div className="min-h-screen bg-cream flex items-center justify-center p-6">
      <div className="max-w-4xl w-full text-center">
        ...
        <h1 className="font-serif text-2xl font-semibold text-ink mb-2">Seu período de teste gratuito acabou</h1>
        <p className="text-ink-4 mb-8">
          Escolha um plano para continuar usando o Terapô.pro e ter acesso completo aos seus pacientes, agenda, prontuários e relatórios.
        </p>
