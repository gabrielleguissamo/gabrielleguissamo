...
export function Button({ variant = 'primary', loading, fullWidth, children, disabled, className = '', ...props }: ButtonProps) {
  const base = 'inline-flex items-center justify-center gap-2 h-12 px-6 font-bold text-sm transition-all duration-200 rounded-[100px] disabled:opacity-50 disabled:cursor-not-allowed'
